...
从 [v0.0.14 Release](https://github.com/cellgit/swift-markdown-kit/releases/tag/v0.0.14) 下载 `SwiftMarkdownKit-0.0.14.xcframework.zip`。解压后把 `SwiftMarkdownKit.xcframework` 拖入 Xcode，加入 App target，并选择 **Embed & Sign**。
