...
```swift
dependencies: [
    .package(url: "https://github.com/cellgit/swift-markdown-kit.git", from: "0.0.11")
]
```
...
Download `SwiftMarkdownKit-0.0.11.xcframework.zip` from the [v0.0.11 release](https://github.com/cellgit/swift-markdown-kit/releases/tag/v0.0.11). Drag `SwiftMarkdownKit.xcframework` into Xcode, add it to the app target, and select **Embed & Sign**.
